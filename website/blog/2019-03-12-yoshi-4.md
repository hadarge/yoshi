...
The highlights of the version are listed below. For the migration guide, follow [this link](https://github.com/wix/yoshi/blob/version_4.x/docs/migration/version-4.md).
