...
* [#208](https://github.com/wix-private/yoshi/pull/208) Add the `--ssl` option to `start` that serves the app bundle on https

#### :bug: Bug
* [#257](https://github.com/wix-private/yoshi/pull/257) HMR "auto" fallbacks to default entry if non supplied
* [#250](https://github.com/wix-private/yoshi/pull/250) Fix wallaby-jest to work with Stylable

## 2.1.6 (May 2, 2018)

#### :bug: Bug
* [#237](https://github.com/wix-private/yoshi/pull/237) Consider the different runtime context for wallaby setup function

#### :house: Internal
* [#243](https://github.com/wix-private/yoshi/pull/243) Remove custom publish script and use CI's built-in one instead
* Remove a dependency on `semver`
* [#245](https://github.com/wix-private/yoshi/pull/245) Release script will now exit with status code 0 if running in CI
* [#231](https://github.com/wix-private/yoshi/pull/231) Add contribution templates for issues and pull requests
* [#246](https://github.com/wix-private/yoshi/pull/246) Improve test and reduce flakiness by creating symlinks instead of installing specific dependencies
* [#249](https://github.com/wix-private/yoshi/pull/249) Internal refactor to `protractor.conf.js`
